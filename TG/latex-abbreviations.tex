...
\newcommand{\vect}[2]{{\ensuremath{\lrt{\begin{array}{c} {#1} \\ {#2} \\ \end{array}}}}}
\newcommand{\system}[1]{{\ensuremath{\left\{ \begin{array}{l} #1 \end{array} \right.}}}
\newcommand{\partdef}[1]{{\ensuremath{\left\{ \begin{array}{lr} #1 \end{array} \right.}}}
...
\def\eqn{\begin{equation*}\begin{aligned}}
\def\endeqn{\end{aligned}\end{equation*}}
