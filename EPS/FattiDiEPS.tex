...
\begin{document}
	...
	Gaussiana & $\frac{1}{\sqrt{2\pi}\sigma}e^{-\frac{(x-m)^2}{2\sigma^2}}$ & $m$ & $\sigma^2$ & $\sigma > 0$, $m\in\bbR$ \\
	\end{tabular} \vskip 1em
	\begin{tabular}{ll}
	{\bf Nome} & {\bf Com'è definita} \\
	Chi-Quadro & $\Chi^2(n) \sim \Gamma(\frac{n}{2}, \frac{1}{2})$ (Se $(X_1, \ldots, X_n)$ sono gaussiane indipendenti $N(0,1)$, allora $X_1^2 + \ldots + X_n^2$ ha legge $\Chi^2(n)$) \\
	Student & $X \sim N(0,1)$, $Y \sim \Chi^2(n)$ indipendenti, allora $T(n)$ ha legge $\frac{\sqrt{n}X}{\sqrt{Y}}$ \\
	\end{tabular} \vskip 1em
	...
	\begin{itemize}
		...
		\item $X \sim N(0,1) \implies X^2 \sim \Gamma(\frac{1}{2}, \frac{1}{2})$
	\end{itemize}
