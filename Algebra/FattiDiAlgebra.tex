...
\begin{document}
	...
	\begin{itemize}
		...
		\item $G \cong H \rtimes_\varphi K$. Allora $(h, k) \in G$ sta nel centro $\sse$ $k \in \Ker \varphi$ (Può essere utile per mostrare che due prodotti semidiretti NON sono isomorfi)
	\end{itemize}
\;
