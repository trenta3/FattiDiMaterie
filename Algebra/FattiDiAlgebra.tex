...
\begin{document}
	...
	\begin{itemize}
		...
		\item $(G \times K)' = G' \times K'$
		\item $G \cong K \rtimes_\varphi H$. Allora $(k, h) \in Z(G)$ sta nel centro $\sse$ $k \in \Fix(\Img \varphi), h \in Z(H), \gamma_{k^-1} = \varphi_h$. Inoltre, se $H, K$ sono abeliani le condizioni diventano $k \in \Fix(\Img(\varphi)), h \in \Ker \varphi$, ovvero $Z(G \rtimes_\varphi H) = \Fix(\Img \varphi) \times \Ker \varphi$ SE SONO ABELIANI.
	\end{itemize}
\;
